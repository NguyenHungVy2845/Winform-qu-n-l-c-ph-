...
namespace QuanLyCafe
{
    public partial class QuanLy : Form
    {
        ...
        // (Giữ nguyên toàn bộ code Quản lý Tài khoản)
        ...
        private void dtgvAccount_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dtgvAccount.SelectedCells.Count > 0)
            {
                ...
                if (cbRole.Items.Contains(roleStr))
                    cbRole.SelectedItem = roleStr;
            }
        }
        ...
        private void btnAddAccount_Click(object sender, EventArgs e)
        {
            ...
            using (QuanLyCafeDataContext db = new QuanLyCafeDataContext())
            {
                ...
                TaiKhoan tk = new TaiKhoan()
                {
                    ...
                    MatKhauMaHoa = "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92", // Pass: 123456 (UTF8)
                    DangHoatDong = true,
                    NgayTao = DateTime.Now
                };
                db.TaiKhoans.InsertOnSubmit(tk); db.SubmitChanges();
        ...
        private void btnEditAccount_Click(object sender, EventArgs e)
        {
            ...
            using (QuanLyCafeDataContext db = new QuanLyCafeDataContext())
            {
                ...
                else MessageBox.Show("Không tìm thấy tài khoản này!");
            }
        }
        ...
        private void btnResetPass_Click(object sender, EventArgs e)
        {
            ...
            using (QuanLyCafeDataContext db = new QuanLyCafeDataContext())
            {
                ...
                if (tk != null)
                {
                    tk.MatKhauMaHoa = "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92"; // Reset về 123456 (UTF8)
                    db.SubmitChanges();
                    MessageBox.Show("Đã đặt lại mật khẩu cho [" + userName + "] thành: 123456");
                }
            }
        }
        #endregion
